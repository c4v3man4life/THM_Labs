sudo nmap -sV -T4 -A -o -p- -vv 10.10.220.47 

# Results
Host is up, received timestamp-reply ttl 61 (0.089s latency).
Scanned at 2022-11-16 08:41:51 EST for 78s
...
SF-Port9999-TCP:V=7.93%I=7%D=11/16%Time=6374E8BB%P=x86_64-pc-linux-gnu%r(N
...
TCP/IP fingerprint:
OS:SCAN(V=7.93%E=4%D=11/16%OT=9999%CT=1%CU=40644%PV=Y%DS=4%DC=T%G=Y%TM=6374
OS:E8ED%P=x86_64-pc-linux-gnu)SEQ(SP=FF%GCD=1%ISR=10B%TI=Z%CI=Z%II=I%TS=8)O
OS:PS(O1=M506ST11NW7%O2=M506ST11NW7%O3=M506NNT11NW7%O4=M506ST11NW7%O5=M506S
OS:T11NW7%O6=M506ST11)WIN(W1=45EA%W2=45EA%W3=45EA%W4=45EA%W5=45EA%W6=45EA)E
OS:CN(R=Y%DF=Y%T=40%W=4602%O=M506NNSNW7%CC=Y%Q=)T1(R=Y%DF=Y%T=40%S=O%A=S+%F
...
Uptime guess: 0.004 days (since Wed Nov 16 08:37:22 2022)
...
1   23.81 ms 10.6.0.1
2   ... 3
4   90.68 ms 10.10.220.47

# Next
nc 10.10.93.245 9999just asks for password

# Next

dirsearch http://10.10.93.245:10000
found /bin
went there and found brainpan.exe

# Next

Moved it to windows VM
